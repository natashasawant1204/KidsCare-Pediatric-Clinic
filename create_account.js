...
import { collection, addDoc ,updateDoc,doc} from "https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js";
...
async function addUser(formData) {
    try {
        ...
        const docRef = await addDoc(collection(db, "users"), {
            id: "", // Placeholder, updated after getting docRef.id
        ...
        // Update Firestore with the actual document ID
